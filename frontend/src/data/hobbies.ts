...
export const HOBBY_APPS: HobbyApp[] = [
  {
    ...
    name: 'Veveno',
    subtitle: '가게 노트',
    description: '메뉴·재고·근무를 한곳에 남기는 손안의 가벼운 매장 노트',
    category: '라이프',
    path: '/hobbies/veveno',
  ...
  },
  {
    ...
    name: 'Score Viewer',
    subtitle: '악보 뷰어',
    description: '악보를 열고 메트로놈·조옮김·자동 스크롤로 연습',
    category: '음악',
  ...
  },
  {
    ...
    name: '6PICK',
    subtitle: '로또 번호',
    description: '빈출 번호를 분석 및 기간 별 패턴을 분석해 번호 분석',
    category: '라이프',
    path: '/hobbies/6pick',
...
export function getHobbyMediaSrc(app: HobbyApp): string | undefined {
  return app.productImage ?? app.productImageDark ?? app.iconSrc;
}
